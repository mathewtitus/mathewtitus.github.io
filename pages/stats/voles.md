...
<center style="background-color: rgb(152, 152, 152);">
  <br>
  <img src="/images/voles_sim.png" alt="Random path through plots" style="width:80%;" />
  <br><span style="color:black">
  _Figure X: Simulated stand with trees (<span style="color:rgb(34, 139, 34)">without nests</span> and <span style="color:rgb(205, 92, 92)">with nests</span>), <span style="color:rgb(255, 250, 205)">plots and the path</span> between them, and <span style="color:rgb(255, 215, 0)">climb plots</span>. Opacity is higher for trees that more easily surveyed; compare the climb plots to the unsurveyed forest._
  </span>
</center>
<!-- 
floor_0: 152.0
...
plot_1: 250.0
plot_2: 205.0
climbed_plot_0: 255.0
climbed_plot_1: 215.0
climbed_plot_2: 0.0
tree_0: 34.0
tree_1: 139.0
tree_2: 34.0
